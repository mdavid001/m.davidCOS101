fn main(){
	...
	//this means that the slice starts from index 0 and goes up to index 3 (exclusive)
	println!("index 0 to index 3 sliced : {:?}",slice2 );

	//omit the end index
	let slice3 = &numbers[2..];
	//this means that the slice starts from index 2 and goes up to index 5 (exclusive)
	println!("index 2 to index 5 sliced : {:?}",slice3 );	

	//omit the start index and end index
	//reference the whole array
	let slice4 = &numbers[..];
	//this means that the slice starts from index 0 and goes up to index 5 (exclusive)
